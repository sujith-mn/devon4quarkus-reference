...
@Tag(name = "product", description = "Product API.") }, info = @Info(title = "ProductCatalog  Quarkus demo", version = "1.0.0", contact = @Contact(name = "API Support", email = "support@acme.com")))
/**
